...
| Front Door: UniFi Access Unlock Relay | When the Shelly Wave 1 Mini relay fires from a UniFi Access unlock event (mobile app, face unlock, NFC, or PIN), unlock the front door Wyze lock via Z2M. |
