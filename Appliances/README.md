...
| V2- Doorbell - Person Detected | G6 Pro Doorbell person detection triggers cooldown, bedroom alert light, notification, and camera stream to bedroom TV. Uses medium resolution channel (1440x1920) as high-res portrait stream is not rendered correctly by Chromecast. |
| Vacuum 6- Bedroom & 1- Bathroom via Zooz button 4 | 2x press of button 4 calls vacuum to clean bedroom and bathroom. |
